...
SECRET_KEY = 'django-insecure-akx9plir%n&_^on897a%tl*l*62#1n%_!u68o64qch-wy57d9r'
...
DB_NAME = 'mongodb+srv://<username>:<password>@<cluster-name>.mongodb.net/newdatabase'
